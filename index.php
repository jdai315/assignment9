...
<section id="main-image">
    ...
    <div class="image-overlay">
        <div class="image-overlay-text">
            ...
            <p>University of Rochester Dining provides more than just your average dining experience. We strive to provide our customers with the best service, experience and most importanly, the most delicious cuisine!</p>
        </div>
    </div>
</section>
    ...
    <section id="about">
        <div class="row align-items-center">
            <div class="column col-md-8 col-sm-6 col-xs-12">
                <h2>About</h2>
                <p>We have a deep respect for and commitment to protecting and improving the environment while making a positive impact in the lives of our local and global community. Please let us know how we are doing!</p>
            </div>
            <div class="column col-md-4 col-sm-6 col-xs-12">
                <div class="button">
                    <button type="button" class="btn btn-primary"><a href="#survey">Complete Survey!</a></button>
                </div>
            </div>
        </div> 
    </section>
